...
cur.execute("GRANT SELECT, INSERT, UPDATE ON mydatabase.User_Allergens TO 'Guest'")
cur.execute("GRANT SELECT, INSERT, UPDATE, DELETE ON mydatabase.Users TO 'Guest'")
